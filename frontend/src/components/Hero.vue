<template>
  <section id="profil" class="container mx-auto px-6 py-20 flex flex- col md:flex-row items-center">
    <div class="md:w-1/2 mb-10 md:mb-0">
      ...
      >
        Halo, Saya <span class="text-blue-600">Akbar Rizqy Effendi</span>
      </h1>
      <p class="text-xl text-gray-600 mb-8 animate-slide-in-left" style="animation-delay: 400ms">
        Mahasiswa Teknik Informatika yang bersemangat dalam pengembangan web dan desain antarmuka, sekaligus penggiat perkembangan teknologi.
      </p>
      <a
        href="#kontak"
